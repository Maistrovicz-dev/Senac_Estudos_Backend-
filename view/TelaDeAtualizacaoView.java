...
public class TelaDeAtualizacaoView extends JFrame {
    ...
    public TelaDeAtualizacaoView() {
        ...
        try {
            ImageIcon originalIcon = new ImageIcon("C:\\Users\\jhulyan.9947\\Desktop\\12-11\\TelaDeMenu\\src\\view\\resources\\icone.png");
            Image resizedIcon = originalIcon.getImage().getScaledInstance(94, 94, Image.SCALE_SMOOTH);
